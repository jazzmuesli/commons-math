...
public class KohonenTrainingTask_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.ml.neuralnet.sofm.KohonenTrainingTask"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(KohonenTrainingTask_ESTest_scaffolding.class.getClassLoader() ,
      "org.apache.commons.math4.linear.ArrayRealVector",
      "org.apache.commons.math4.ml.neuralnet.sofm.KohonenTrainingTask",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Iterator", false, KohonenTrainingTask_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.ml.neuralnet.Network", false, KohonenTrainingTask_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.ml.neuralnet.sofm.KohonenUpdateAction", false, KohonenTrainingTask_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(KohonenTrainingTask_ESTest_scaffolding.class.getClassLoader()); 
