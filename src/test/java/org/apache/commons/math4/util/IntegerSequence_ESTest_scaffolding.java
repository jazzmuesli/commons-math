...
public class IntegerSequence_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.util.IntegerSequence"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IntegerSequence_ESTest_scaffolding.class.getClassLoader() ,
      "org.apache.commons.math4.exception.MathRuntimeException",
      "org.apache.commons.math4.util.IntegerSequence$Incrementor$1",
      "org.apache.commons.math4.util.IntegerSequence",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, IntegerSequence_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.util.IntegerSequence$Incrementor$MaxCountExceededCallback", false, IntegerSequence_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IntegerSequence_ESTest_scaffolding.class.getClassLoader()); 
