...
public class DefaultTransformer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.util.DefaultTransformer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultTransformer_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.commons.math4.util.NumberTransformer",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultTransformer_ESTest_scaffolding.class.getClassLoader()); 
