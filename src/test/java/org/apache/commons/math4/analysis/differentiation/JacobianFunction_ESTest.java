...
public class JacobianFunction_ESTest extends JacobianFunction_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(derivativeStructureArray0).when(multivariateDifferentiableVectorFunction0).value(any(org.apache.commons.math4.analysis.differentiation.DerivativeStructure[].class));
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn((-1776.273003985365), (-1776.273003985365)).when(derivativeStructure0).getPartialDerivative(any(int[].class));
  ...
  public void test2()  throws Throwable  {
      DerivativeStructure[] derivativeStructureArray0 = new DerivativeStructure[1];
      MultivariateDifferentiableVectorFunction multivariateDifferentiableVectorFunction0 = mock(MultivariateDifferentiableVectorFunction.class, new ViolatedAssumptionAnswer());
      doReturn((DerivativeStructure[]) null).when(multivariateDifferentiableVectorFunction0).value(any(org.apache.commons.math4.analysis.differentiation.DerivativeStructure[].class));
      JacobianFunction jacobianFunction0 = new JacobianFunction(multivariateDifferentiableVectorFunction0);
      double[] doubleArray0 = new double[2];
      ...
      try { 
        ...
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.apache.commons.math4.analysis.differentiation.JacobianFunction", e);
      }
  }
}
