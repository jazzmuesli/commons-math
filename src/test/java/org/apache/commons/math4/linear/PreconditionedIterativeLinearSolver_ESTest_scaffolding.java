...
public class PreconditionedIterativeLinearSolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.linear.PreconditionedIterativeLinearSolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PreconditionedIterativeLinearSolver_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.math4.linear.RealLinearOperator", false, PreconditionedIterativeLinearSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.util.IterationManager", false, PreconditionedIterativeLinearSolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PreconditionedIterativeLinearSolver_ESTest_scaffolding.class.getClassLoader()); 
