...
public class GillStepInterpolator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.ode.nonstiff.GillStepInterpolator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GillStepInterpolator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.ObjectInput", false, GillStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.ObjectOutput", false, GillStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.ode.EquationsMapper", false, GillStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GillStepInterpolator_ESTest_scaffolding.class.getClassLoader()); 
