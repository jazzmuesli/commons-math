...
public class NordsieckStepInterpolator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math4.ode.sampling.NordsieckStepInterpolator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.ObjectInput", false, NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.ObjectOutput", false, NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.linear.Array2DRowRealMatrix", false, NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math4.ode.EquationsMapper", false, NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NordsieckStepInterpolator_ESTest_scaffolding.class.getClassLoader()); 
